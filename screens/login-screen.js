...
export function LoginScreen({ route, navigation }) {
  ...
  return (
    ...
    >
      <Text style={{ fontSize: 25, fontWeight: "bold", color: "#1ebba3" , textAlign: "center" }}>
      ...
      <TouchableOpacity
       style={{height: 60,
          ...
          onPress={() =>loginUser()}
          >
        <Text style={{color:'white',fontWeight:'bold',fontSize:20}}>{transLations[screenId].button}</Text>
      </TouchableOpacity>
    </View>
  );
}
